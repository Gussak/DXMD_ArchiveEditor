...
bDarkTheme=true fScale=${fScale-0.65f} java -Dswing.defaultlaf=com.sun.java.swing.plaf.gtk.GTKLookAndFeel -jar ../DXMD_ArchiveEditor.jar "$(pwd)/../Game.layer.1.all.archive" #it is actually a symlink
